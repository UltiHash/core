...
function(add_library_bundle name)
    ...
    target_link_libraries(${name} PUBLIC ${ARGS_PUBLIC})
    target_link_libraries(${name} PUBLIC ${ARGS_PUBLIC_BUNDLE})
    target_link_libraries(${name} PRIVATE ${ARGS_PRIVATE})
    target_link_libraries(${name} PRIVATE ${ARGS_PRIVATE_BUNDLE})
    ...
    #
    #    MESSAGE("Adding library bundle '${name}' with public dependencies '${ARGS_PUBLIC}'")

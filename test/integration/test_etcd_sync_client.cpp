...
// }
//
// BOOST_FIXTURE_TEST_CASE(fails_getting_lock_when_lease_is_invalidated,
// fixture) {
//     auto lease = etcd_client.leasegrant(2).value().lease();
...
//
//         // proclaim
//         auto resp3 = etcd_client.proclaim("test", lease_id,
//         resp1.value().key(),
...
//
//         // resign
//         auto resp5 = etcd_client.resign("test", lease_id,
//         resp1.value().key(),
//                                         resp1.value().created_index());

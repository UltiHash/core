...
BOOST_AUTO_TEST_CASE(read_local_date__handles_seconds) {
    ...
    // Act
    auto date = iso8601_date(detail::read_local_date(str));
    // Assert
    BOOST_CHECK_EQUAL(date, "2011-02-18T23:12:34Z");
}

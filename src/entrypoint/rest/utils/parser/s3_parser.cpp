#include <iostream>
#include "s3_parser.h"
#include "../../http/models/put_object_request.h"
#include "../../http/models/get_object_request.h"
#include "../../http/models/create_bucket_request.h"
#include "../../http/models/list_buckets_request.h"
#include "../../http/models/init_multi_part_upload_request.h"
#include "../../http/models/multi_part_upload_request.h"
#include "../../http/models/complete_multi_part_upload_request.h"
#include "../../http/models/abort_multi_part_upload_request.h"
#include "../../http/models/delete_bucket_request.h"
#include "../../http/models/delete_objects_request.h"
#include "../../http/models/delete_object_request.h"
#include "../../http/models/get_object_attributes_request.h"
#include "../../http/models/list_objectsv2_request.h"
#include "../../http/models/list_objects_request.h"
#include "../../http/models/list_multi_part_uploads_request.h"
#include "../../http/models/get_bucket_request.h"
#include "../../http/http_types.h"
#include "../../http/models/custom_error_response_exception.h"

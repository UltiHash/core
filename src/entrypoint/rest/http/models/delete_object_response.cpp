...
delete_object_response::delete_object_response(const http_request& req)
    : http_response(req) {}

delete_object_response::delete_object_response(
...
delete_object_response::get_response_specific_object() {

...
static const int public_read_write_HASH =
    hash_utils::hash_string("public-read-write");
static const int authenticated_read_HASH =
    hash_utils::hash_string("authenticated-read");
static const int aws_exec_read_HASH = hash_utils::hash_string("aws-exec-read");
static const int bucket_owner_read_HASH =
    hash_utils::hash_string("bucket-owner-read");
static const int bucket_owner_full_control_HASH =
    hash_utils::hash_string("bucket-owner-full-control");

...
list_objectsv2_response::list_objectsv2_response(const http_request& req)
    : http_response(req) {
    m_res.set(boost::beast::http::field::content_type, "application/xml");
    populate_response_headers();
}

list_objectsv2_response::list_objectsv2_response(
...
list_objectsv2_response::get_response_specific_object() {
    ...
    if (m_startAfterHasBeenSet) {
        ...
        //            m_startAfter )
        encoding_type_xml_string =
            "<StartAfter>" + m_startAfter + "</StartAfter>\n";
    }
    ...
    set_body(std::string("<ListBucketResult>\n"
                         ...
                         content_xml_string + name_xml_string +

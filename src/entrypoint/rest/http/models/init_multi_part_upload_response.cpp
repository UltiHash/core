...
init_multi_part_upload_response::init_multi_part_upload_response(
...
void init_multi_part_upload_response::set_upload_id(
    const std::string& upload_id) {
    m_uploadId = upload_id;
}

const http::response<http::string_body>&
init_multi_part_upload_response::get_response_specific_object() {

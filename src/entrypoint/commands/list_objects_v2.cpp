...
http_response get_response(const std::vector<object>& objects,
    ...
    list_bucket_result_node.put("KeyCount", contents_counter + common_prefixes_counter);
    ...
    if(next_continuation_token)
        list_bucket_result_node.put("NextContinuationToken", *next_continuation_token);

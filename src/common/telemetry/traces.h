...
private:
    ...
    static inline opentelemetry::nostd::shared_ptr<opentelemetry::trace::TracerProvider>
        tracer_provider;
#else
    static inline opentelemetry::nostd::shared_ptr<opentelemetry::sdk::trace::TracerProvider>
        tracer_provider;

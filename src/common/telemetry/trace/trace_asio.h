...
//             if (is_started()) {
//                 m_data->SetAttribute(
//                     opentelemetry::nostd::string_view(key.begin(),
//                     key.size()), value);
//             }
//         }
//     }
...
//         if (enable) {
//             auto tracer =
//             trace_api::Provider::GetTracerProvider()->GetTracer(
...
//     }
//
//     auto& start_trace() & { return
//     continue_trace(trace_span::root_context()); }
//
...
//     }
//
//     template <typename U> auto await_transform(awaitable<U, Executor> a)
//     const {

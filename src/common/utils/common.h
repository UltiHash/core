...
constexpr const std::array<std::pair<uh::cluster::message_type, const char*>,
    ...
    string_by_message_type = {{
        ...
        {STORAGE_READ_FRAGMENT_RESP, "storage_read_fragment_response"},
        {STORAGE_READ_ADDRESS_REQ, "storage_read_address_request"},
        {STORAGE_READ_ADDRESS_RESP, "storage_read_address_response"},
        {STORAGE_WRITE_REQ, "storage_write_request"},
        {STORAGE_WRITE_RESP, "storage_write_response"},
        ...
        {STORAGE_USED_RESP, "storage_used_response"},

        {DEDUPLICATOR_REQ, "deduplicator_request"},
        {DEDUPLICATOR_RESP, "deduplicator_response"},

        {DIRECTORY_BUCKET_LIST_REQ, "directory_bucket_list_request"},
        {DIRECTORY_BUCKET_LIST_RESP, "directory_bucket_list_response"},
        ...
        {DIRECTORY_OBJECT_LIST_RESP, "directory_object_list_response"},
        {DIRECTORY_OBJECT_PUT_REQ, "directory_object_put_request"},
        {DIRECTORY_OBJECT_GET_REQ, "directory_object_get_request"},
        {DIRECTORY_OBJECT_GET_RESP, "directory_object_get_response"},

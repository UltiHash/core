...
#ifndef CORE_FDB_HASH_ROUTING_H
#define CORE_FDB_HASH_ROUTING_H
...
namespace uh::an::cluster {
    class fdb_hash_routing : public routing_interface {
    public:
        explicit fdb_hash_routing(const std::unordered_map<std::string, std::unique_ptr<protocol::client_pool>> &nodes);

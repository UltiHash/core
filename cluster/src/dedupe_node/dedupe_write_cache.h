...
namespace uh::cluster {
    ...
    public:
<<<<<<< HEAD
        dedupe_write_cache(std::string_view &integration_data, global_data_view &storage, size_t num_nodes, dedupe_config& config) :
...
>>>>>>> acda0e89eb30a0644dceb2ef6b67005a06619b8f

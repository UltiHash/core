...
- `UH_DEDUPLICATOR_TYPE` - in entrypoint, configure the type of deduplicator to use (`"cluster"`, `"local"` or `"null"`)
- `UH_STORAGE_TYPE` - in entrypoint, configure the type of storage to use (`"cluster"`, `"local"` or `"null"`)

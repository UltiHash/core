...
std::list<const fragment*> dictionary::insert(std::span<char> buffer)
{
...
bool dictionary::insert_at(std::set<fragment>::iterator pos,
...
std::set<fragment>::iterator dictionary::greatest_less_than(std::span<char> buffer)
{
...
std::set<fragment>::iterator dictionary::least_greater_or_equal(std::span<char> buffer)
{

...
class fragment_on_seekable_reset_front_device: public fragment_on_seekable_device
{
...
public:
     ...
     */
    explicit fragment_on_seekable_reset_front_device(io::seekable_device& dev, uint8_t index = 0,

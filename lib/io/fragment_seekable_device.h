...
namespace uh::io {
    ...
    class fragment_seekable_device: public fragment_device {

    public:
        /**
         * a fragment_seekable_device uses a device to either only read or only write,
         ...
         */
        explicit fragment_seekable_device(io::seekable_device& device);

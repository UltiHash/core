...
BOOST_FIXTURE_TEST_CASE_TEMPLATE(read_full, T, license_types, Fixture )
{
    auto dev = make_test_device<T>();
...
BOOST_FIXTURE_TEST_CASE_TEMPLATE(read_partial, T, license_types, Fixture )
{
    auto dev = make_test_device<T>();
...
BOOST_FIXTURE_TEST_CASE_TEMPLATE(data_generator_api, T, license_types, Fixture )
{

...
BOOST_AUTO_TEST_CASE(buffered_serializer_test) {
    ...
    test_range_serialization <std::string, buffered_serializer<sl_serializer>> (str1);
    test_range_serialization < std::vector <long>, buffered_serializer<sl_serializer>> (lvec1);
    test_range_serialization < std::vector <double>, buffered_serializer<sl_serializer>> (dvec1);
    test_range_serialization <std::vector <std::uint8_t>, buffered_serializer<sl_serializer>> (emptyvec);
    test_range_serialization <std::vector <std::uint64_t>, buffered_serializer<sl_serializer>> (largevec);
    test_range_serialization <std::string, buffered_serializer<sl_serializer>> (str2);

    test_range_serialization <unsigned long, buffered_serializer<sl_serializer>> (ov1);
    test_range_serialization <double, buffered_serializer<sl_serializer>> (ov2);

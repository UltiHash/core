...
struct tree_node_serialize_size_format
  ...
  {
    uh::io::buffer buf;
    uh::io::write(buf, uh::serialization::fragment_serialize_size_format<uint64_t, true>::serialize());
  ...
  {
    uh::serialization::fragment_serialize_size_format<uint64_t, true>::deserialize(input_dev);
  ...
  {
    return uh::serialization::fragment_serialize_size_format<uint64_t, true>::serialized_size() + 1 + chunk_num_buf_size;
  }
};
